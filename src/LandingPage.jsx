            ...
            <div className="w-screen h-screen bg-white relative overflow-hidden font-montserrat">
                ...
                <div className={"relative w-full h-[300px]"}>
                    ...
                    <div className="h-[100px] w-[250px] absolute top-0 right-0 flex items-center justify-center space-x-4 mr-6">
                        <button className="bg-blue-500 text-white py-2 px-6 rounded-3xl z-20"
                                onClick={() => navigate('/register')}>
                            Register
                        </button>
                        <button className="bg-blue-500 text-white py-2 px-8 rounded-3xl z-20"
                                onClick={() => navigate('/register')}>
                            Login
                        </button>
                    </div>
                    ...
                    <div className="w-full h-[300px] flex items-center justify-center space-x-8">
                        ...
                        <div className="flex flex-col">
                            <div className="font-bold text-6xl">
                                ...
                                <p className="bg-gradient-to-r from-primary_blue to-secondary_blue bg-clip-text text-transparent">Socialize</p>
                            </div>
                            <p className="font-medium text-white">A place to post your story, socializing with your</p>
                            <p className="font-medium text-white">friends, and express your emotion freely!</p>
                        </div>
                    </div>
                </div>
            </div>
